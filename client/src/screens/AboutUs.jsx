import { Box, Center,Flex,Heading, Container, Text,Breadcrumb,BreadcrumbItem } from "@chakra-ui/react";
    ...
    return (
        <Box maxW="8xl" mx="auto" p={{ base: '0', lg: '12' }} minH="8xl">
             <Flex
                            ...
                            overflow="hidden"
                        >
                            <Box flex="1" zIndex={1} textAlign={{ base: "center", md: "left" }} pl={{ md: 12 }}>
                                <Heading
                            ...
                            <Box
                                ...
                                position="absolute"
                                top="-30px"
                                left={{base:'120px',md:'30px'}}
                                width={{base:'140px',md:'350px'}}
                                height={{base:'140px',md:'350px'}}
